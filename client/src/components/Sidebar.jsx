...
const Sidebar = () => {
  ...
  // ----------------- MARK CHANGE 1 -----------------
  // State to toggle menu on mobile
      ...
      <div className="pb-5">
        <div className="flex items-center justify-between">
          ...
          <div className="relative py-2 group">
            ...
            {/* Mobile click */}
            {menuOpen && (
              <div className="absolute top-full right-0 z-20 w-32 p-5 rounded-md bg-[#282142] border border-gray-600 text-gray-600 md:hidden">
                <p
                  onClick={() => {
                    navigate("/profile");
                    setMenuOpen(false);
